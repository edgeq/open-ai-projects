...
const createStore = () =>
    MemoryVectorStore.fromDocuments(
        ...
        // this will convert these documents to OpenAI Embeddings.
        // It also costs money to retrieve embeddings 💸
    ...
    const search = async (query, count = 1) => {
        ...
        // langchain is neat! 
        // The api already exposes similarity search
        // and other helpful/commonly used algorithms
        // i.e: store.similaritySearchWithScore(query, count)
        // You don't necessarily have to code your own 
        return store.similaritySearch(query, count)
    }

    console.log(await search('laughs and irreverance'))